...
Local control is off by default. The Electron main process owns the bundled CUA driver lifecycle so operating-system permissions are attributed to Sandbase bot rather than a background helper.
