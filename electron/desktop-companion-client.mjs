...
/** Pairing tokens may travel through a verified Sandbase bot HTTPS endpoint or
...
export async function pairDesktopCompanion({
  ...
  if (!endpoint) {
    throw new Error("Enter the Sandbase bot HTTPS companion address or full Tailscale name ending in .ts.net");
  }
