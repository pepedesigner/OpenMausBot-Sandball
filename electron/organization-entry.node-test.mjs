...
test("consuming a launch action prevents it replaying on a later restart without changing other arguments", () => {
  const original = ["/Applications/Sandbase bot", "--profile=fixture", "openmausbot://organization?ignored", "openmausbot://install/example"];
...
test("the actual companion relaunch passes consumed arguments explicitly to Electron", () => {
  ...
  const argv = ["/fixture/Sandbase bot", "--fixture", "openmausbot://organization", "openmausbot://organization?ignored"];
