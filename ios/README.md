...
person can choose **Sandbase bot**, review the paired computer and destination,
...
through manual MagicDNS entry; it is not a dependency and Sandbase bot does not
