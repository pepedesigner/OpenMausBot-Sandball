...
OpenMausMobile is a companion for the Sandbase bot desktop application. The
...
1. Install and start Sandbase bot on a Mac, Windows, or Linux computer.
...
6. In Safari, Notes, Photos, or Files, open the system Share sheet and choose
   **Sandbase bot**. The extension shows the paired computer and asks for a bot
   ...
   awake with Sandbase bot running.
...
specific computer and receives no universal Sandbase bot account credential.
The reviewer may use any email inbox they control. This optional path uses an
Sandbase bot-managed Cloudflare Tunnel and does not require Tailscale.
