...
- Privacy policy URL:
  `https://github.com/pepedesigner/Sandbase-bot/blob/main/docs/ios-privacy.md`
...
companion computer, and local Wi-Fi and Tailscale pairing require no Sandbase bot
...
**Send**. They are written to that computer's local Sandbase bot attachments
