    ...
    private static func confirmServer(at connection: Connection) async throws {
        ...
        do {
            ...
            throw APIError.transport(
                "\(connection.displayAddress) isn't an Sandbase bot server. Check the address and try again."
            )
        }
    }
        ...
        do {
            ...
            if attachments.contains(where: { $0.kind == .image }) {
                ...
                do {
                    ...
                    actionError = "Update Sandbase bot on this computer before sending images."
                    return false
                }
