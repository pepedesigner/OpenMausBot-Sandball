  ...
  JSON.stringify(
    {
      name: "openmausbot",
      version: app.version,
      description: "Run the Sandbase bot server anywhere and pair your devices to it",
      license: "Apache-2.0",
      type: "module",
      bin: { openmausbot: "cli.js" },
      files: ["cli.js", "dist-server", "dist", "skills", "enterprise", "LICENSE", "README.md"],
      engines: { node: ">=24" },
      repository: { type: "git", url: "https://github.com/pepedesigner/Sandbase-bot.git" },
      homepage: "https://github.com/pepedesigner/Sandbase-bot#readme",
...
Managed access uses a separate Sandbase bot account and asks permission for
...
Sandbase bot app; the web address is printed beside it if you would rather
...
\`login\` command signs in to an Sandbase bot account, not an AI provider;
it does not start the tunnel itself.

[Setup guide](https://github.com/pepedesigner/Sandbase-bot/blob/main/docs/cli-onboarding.md)
· [Hosting guide](https://github.com/pepedesigner/Sandbase-bot/blob/main/docs/self-hosting.md)
`,
);
