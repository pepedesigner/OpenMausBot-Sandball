...
function translationPrompt(source, label, code) {
  return [
    `Translate this JSON UI catalog for Sandbase bot, a multi-agent desktop workbench, into ${label} (${code}).`,
    ...
    "Keep placeholders such as {name} exactly, including duplicates. Keep Sandbase bot, CLI, and AI unchanged.",
