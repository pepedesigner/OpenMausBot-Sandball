...
if (process.versions.electron && process.argv.includes(flag)) {
  ...
  app.whenReady().then(async () => {
    ...
    await until(() => evaluate("document.body.textContent.includes('Fully quit Sandbase bot') && !document.querySelector('dialog[open]')"), "restart-required confirmation");
    ...
    await until(() => evaluate("document.body.textContent.includes('Fully quit Sandbase bot')"), "pending restore on reopen");
