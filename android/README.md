# Sandbase bot Android companion

The Android counterpart to the iOS companion app: pair a phone with a computer
running Sandbase bot, then read and answer from the phone.
...
**Sandbase bot Preview**, its application ID is `com.openmausbot.companion.preview`,
