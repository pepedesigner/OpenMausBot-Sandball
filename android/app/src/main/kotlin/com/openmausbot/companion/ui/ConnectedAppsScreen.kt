        ...
        Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(6.dp)) {
            ...
            Text(
                if (hasLastKnownInventory) {
                    "Showing what was connected last time. Your computer could not open its credential store just now, so these accounts could not be re-checked. Nothing has been disconnected — restarting Sandbase bot on your computer usually clears this."
                } else {
                    "Your computer could not open its credential store, so it cannot say which accounts are connected. Nothing has been disconnected — restarting Sandbase bot on your computer usually clears this."
                },
                color = secondaryTint,
                fontSize = 13.sp,
            )
