...
object ProfileRules {
    ...
    private const val GENERATE_BLOCKED_FOOTER: String =
        "To generate images, configure the shared image provider in Sandbase bot on your " +
    ...
    private const val SYSTEM_VOICE_UNCONFIGURED_FOOTER: String =
        "Your computer's built-in voices need no key, and it reports none it can use. Switch " +
            "the voice engine in Sandbase bot on the computer to turn speech back on."
    ...
    private const val FISH_VOICE_UNCONFIGURED_FOOTER: String =
        "Add the shared Fish Audio API key in Sandbase bot on the computer. The key is " +
            "never returned to this phone."
    ...
    private const val CHATTERBOX_VOICE_UNCONFIGURED_FOOTER: String =
        "Add the address of your Chatterbox server in Sandbase bot on the computer to turn " +
            "speech back on."
