...
// there as first-class pi tools (pi.registerTool). Sandbase bot ships this file
// and the pi driver spawns it — the pi repo itself is never touched.
//
// Protocol: the Sandbase bot proxies speak raw JSON-RPC 2.0 over stdio, one
 ...
 * Keeping it local avoids bundling Pi into Sandbase bot; the extension is
...
/** A minimal stdio JSON-RPC 2.0 MCP client, matched to Sandbase bot's
