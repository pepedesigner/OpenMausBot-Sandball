...
const SUBJECTS = {
  "sign-in": "Your Sandbase bot sign-in code",
  "email-verification": "Verify your Sandbase bot email",
  "forget-password": "Reset your Sandbase bot password",
  "change-email": "Confirm your Sandbase bot email change",
...
export function buildOTPEmail(from: string, input: OTPEmailInput) {
  ...
  return {
    to: input.email,
    from: { email: from, name: "Sandbase bot" },
    subject,
    html,
    text,
  };
