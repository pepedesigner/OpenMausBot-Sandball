        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <div className="flex items-center justify-between border-b border-hairline/40 px-3 py-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[12px] font-semibold text-ink">Sand ball</span>
            </div>
          ...
          <div className="flex flex-1 flex-col justify-end gap-2 px-3 pb-2.5">
            ...
            <div className="mt-1 h-7 rounded-lg border border-hairline/40 bg-inset px-2.5 text-[10.5px] leading-7 text-ink-secondary">Message Sand ball</div>
          </div>
        </div>
