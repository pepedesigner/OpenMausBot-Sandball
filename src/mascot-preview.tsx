    ...
    <main className="preview-shell">
      <header className="preview-header">
        <div>
          ...
          <h1>Sand ball motion library</h1>
          <p className="intro">
            The app&rsquo;s body — a ball of sand, with the face engine behind it. Expressions
            morph on a spring, blink on each state&rsquo;s own rhythm, and the eyes wrap around an
            implied sphere so a turn reads as a head turning — the silhouette itself never rotates.
          </p>
        </div>
      ...
      <section className="expression-library" aria-labelledby="expression-heading">
        <div className="section-heading">
          ...
          <p>Move your pointer over any Sand ball to test the responsive eyes.</p>
        </div>
