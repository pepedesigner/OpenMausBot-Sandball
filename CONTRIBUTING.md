...
- stable `Sandbase-bot-amd64.deb` and `Sandbase-bot.AppImage` copies used by the latest-download links;
...
[Sandbase bot releases](https://github.com/milind-soni/OpenMausBot/releases). Then verify the checksum
...
Sandbase bot release repository, and never change the upstream publish target in a feature PR unless
