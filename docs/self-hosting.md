# Self-hosting the Sandbase bot server
...
Step by step, for a server you do not have yet: [Deploy Sandbase bot on a
...
The code itself comes from `accounts.openmausbot.com`, the Sandbase bot
