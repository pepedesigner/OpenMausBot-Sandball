...
**Goal:** Add OpenCode Go as an optional ACP-backed Sandbase bot engine with dynamic models, write-only credentials, setup UX, and comprehensive tests.
...
- [ ] Add cross-platform setup commands, docs URL, and a login note that never asks Sandbase bot to edit OpenCode auth files.
