...
[Sandbase bot releases](https://github.com/milind-soni/OpenMausBot/releases).
...
`milind-soni/Sandbase bot`. For that reason:
...
Set these in **Sandbase bot → Settings → Secrets and variables → Actions**.
