...
The bot turns calendar timing into a cron expression, and Sandbase bot validates
...
- Sandbase bot must be running to dispatch routines, including cloud-targeted
  ...
  Sandbase bot on a VPS — see [deploy-vps.md](deploy-vps.md).
