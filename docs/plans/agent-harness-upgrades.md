# Sandbase bot harness implementation plan
...
(pi, agent-orchestrator, deepseek-harness) and asking what Sandbase bot lacked by
...
**The reframe that reorders everything.** Sandbase bot is itself a harness. The
