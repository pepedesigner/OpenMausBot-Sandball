# Verifying Sandbase bot

Sandbase bot has one development control surface: `pnpm control:omb`. It is a
...
that exact child. The parent shell and the user's Sandbase bot data are
